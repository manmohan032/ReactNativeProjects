...
export const playList:Track[] =[
    {
        ...
        url: require('./assets/music-asset/one.mp3'),
      },
      {
        id: 1,
        ...
        url: require('./assets/music-asset/two.mp3'),
      },
      {
        id: 2,
        title: 'Kesariya',
        ...
        url: require('./assets/music-asset/three.mp3'),
      },
      {
        id: 3,
        title: 'Title Track',
        ...
        url: require('./assets/music-asset/four.mp3'),
      },
      {
        id: 4,
        title: 'Besharam Rang',
        ...
        url: require('./assets/music-asset/five.mp3'),
      },
    ];
